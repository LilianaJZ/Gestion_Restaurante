class Cliente:
    def _init_(self, id=None, nombre=None, mail=None, telefono=None, ordenes=None):
        self.__id = id
    ...
    def _str_(self):
        return f"Cliente(id={self._id}, nombre={self.nombre}, mail={self.mail}, telefono={self.telefono}, ordenes={len(self._ordenes)})"